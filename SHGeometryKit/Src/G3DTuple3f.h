...
// Software Foundation
//
// $Id: G3DTuple3f.h,v 1.4 2002/10/25 10:14:51 probert Exp $
//-----------------------------------------------------------------------------

/*!
   @class      G3DTuple3f
   @abstract   A generic 3-element tuple represenation. 
   @discussion A generic 3-element tuple that is represented by single-precision 
               floating point coordinates.
*/

#ifndef __G3DTuple3f_h_INCLUDE
#define __G3DTuple3f_h_INCLUDE

#import <Foundation/Foundation.h>

@interface G3DTuple3f : NSObject <NSCoding, NSCopying>
{
  float _tuple[3];
}
...
/*! 
   ...
   @abstract Sets the value of this tuple to the scalar division of itself by 
             the passed single-precision value. Raises a G3DTuple3fException exception
...
/*! 
   ...
   @param values A 3-element single-precision array.
...
/*! 
   ...
   @param z A single-precision value.
*/
- (void)setZ:(float)z;
...
/*! 
   ...
   @param aTuple A 3-element single-precision tuple.
*/
...
extern NSString *G3DTuple3fException;
