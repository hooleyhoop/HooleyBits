...
// Software Foundation
//
// $Id: G3DVector3d.h,v 1.4 2002/10/25 10:14:51 probert Exp $
//-----------------------------------------------------------------------------

/*!
   @class      G3DVector3d
   @abstract   A generic 3-element vector representation. 
   @discussion A generic 3-element vector that is represented by double-precision 
               floating point coordinates.
*/

#ifndef __G3DVector3d_h_INCLUDE
#define __G3DVector3d_h_INCLUDE

#import <Foundation/Foundation.h>
#import "G3DTuple3d.h"

@interface G3DVector3d : G3DTuple3d
{
}
