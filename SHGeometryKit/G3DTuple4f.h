...
// Software Foundation
//
// $Id: G3DTuple4f.h,v 1.4 2002/10/25 10:14:51 probert Exp $
//-----------------------------------------------------------------------------

/*!
   @class      G3DTuple4f
   @abstract   A generic 4-element tuple represenation. 
   @discussion A generic 4-element tuple that is represented by single-precision 
               floating point coordinates.
*/

#ifndef __G3DTuple4f_h_INCLUDE
#define __G3DTuple4f_h_INCLUDE

#import <Foundation/Foundation.h>

@interface G3DTuple4f : NSObject <NSCoding, NSCopying>
{
  float _tuple[4];
}
...
/*! 
   ...
   @abstract Creates a tuple initialised with the elements 
             [0.0, 0.0, 0.0, 0.0] by invoking initWithElements:. 
...
/*! 
   ...
   @abstract Creates a tuple initialised with the elements X, Y,Z and W by 
             invoking initWithElements:.
   @param x single-precision x value.
   @param y single-precision y value.
   @param z single-precision z value.
   @param w single-precision w value.
   @result  Returns the newly initialised tuple object or nil on error.
*/
...
- (id)initWithTuple:(G3DTuple4f *)aTuple;
  // Initialises a new tuple by invoking initWithElements
...
/*! 
   ...
   @abstract Sets the value of this tuple to the scalar division of itself by 
             the passed single-precision value. Raises a G3DTuple4fException exception
...
/*! 
   ...
   @param values A 4-element single-precision array.
...
/*! 
   ...
   @result Returns a single-precision value representing the 3rd element of the tuple.
*/
- (float)z;
...
/*! 
   @method w
   @abstract Returns the 4th element of the tuple.
   @result Returns a single-precision value representing the 4th element of the tuple.
*/
- (float)w;

/*! 
   @method setW:
   @abstract Sets the 4th element of the tuple.
   @param w A single-precision value.
*/
- (void)setW:(float)w;
...
/*! 
   ...
   @param aTuple A 4-element single-precision tuple.
*/
...
extern NSString *G3DTuple4fException;
