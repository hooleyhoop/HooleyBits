...
// Software Foundation
//
// $Id: G3DTuple4d.h,v 1.4 2002/10/25 10:14:51 probert Exp $
//-----------------------------------------------------------------------------

/*!
   @class      G3DTuple4d
   @abstract   A generic 4-element tuple represenation. 
   @discussion A generic 4-element tuple that is represented by double-precision 
               floating point coordinates.
*/

#ifndef __G3DTuple4d_h_INCLUDE
#define __G3DTuple4d_h_INCLUDE

#import <Foundation/Foundation.h>

@interface G3DTuple4d : NSObject <NSCoding, NSCopying>
{
  double _tuple[4];
}
...
/*! 
   ...
   @param w double-precision w value.
   @result  Returns the newly initialised tuple object or nil on error.
*/
...
/*! 
   ...
   @abstract Sets the value of this tuple to the scalar division of itself by 
             the passed double-precision value. Raises a G3DTuple4dException exception
...
/*! 
   ...
   @param values A 4-element double-precision array.
...
/*! 
   ...
   @result Returns a double-precision value representing the 4th element of the tuple.
*/
- (double)w;
...
/*! 
   ...
   @param w A double-precision value.
*/
- (void)setW:(double)w;
...
/*! 
   ...
   @param aTuple A 4-element double-precision tuple.
*/
...
extern NSString *G3DTuple4dException;
